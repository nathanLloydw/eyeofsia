<section class="container mx-auto px-6 lg:px-14 py-12 lg:py-24 flex flex-wrap">
    ...
    <div class="lg:w-2/3 mx-auto">
        <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4">
            <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 absolute inset-0 aspect-[2.41/1]" src="{{ $component['images'][0]['image']['permalink'] ?? 'https://dummyimage.com/820x340' }}">
        ...
        <div class="flex flex-wrap -mx-2">
            <div class="px-2 w-1/2">
                <div class="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
                    <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 absolute inset-0 aspect-[1.18/1]" src="{{ $component['images'][1]['image']['permalink'] ?? 'https://dummyimage.com/542x460' }}">
                    <div class="text-center relative z-10 w-full">
            ...
            <div class="px-2 w-1/2">
                <div class="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
                    <img alt="gallery" class="w-full object-cover h-full object-center block opacity-25 absolute inset-0 aspect-[1.18/1]" src="{{ $component['images'][2]['image']['permalink'] ?? 'https://dummyimage.com/542x420' }}">
                    <div class="text-center relative z-10 w-full">
